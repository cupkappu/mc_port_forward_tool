...
/**
 * One server-side transport stream (DIRECT mode): a Minecraft frame channel
 * endpoint multiplexed with the fixed target TCP socket.
 *
 ...
 */
public final class DirectServerStream implements ServerStream {
    ...
    public DirectServerStream(PlayerTunnelSession session,
                        int streamId,
                        Socket targetSocket,
                        BufferBudget budget,
